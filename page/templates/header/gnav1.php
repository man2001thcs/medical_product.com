<nav>
	<ul id="dropmenu">
		<li>
			<a href="<?php echo BASE_URL; ?>page/product/medicine/">Thuốc</a>
			<ul>
		...
		<li>
			...
			<ul>
				<li><a href="<?php echo BASE_URL; ?>page/manufacturer/create.php">Create</a></li>
				<li><a href="<?php echo BASE_URL; ?>page/manufacturer/">List</a></li>
			</ul>
		</li>
		<li>
			<a href="<?php echo BASE_URL; ?>user/">Danh sách khách hàng</a>
		</li>
		<li>
			<a href="">Hóa đơn</a>
			<ul>
